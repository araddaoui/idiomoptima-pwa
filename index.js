...
const SYSTEM_PROMPT = [
  ...
  "revisedScore: Rate the REVISED text after your corrections. It MUST be higher than originalScore if you made improvements.",
  "  - The gap between scores MUST reflect the magnitude of improvements.",
  "  - If you fixed 5 spelling errors + 2 grammar issues, the gap should be 15-30 points.",
  "  - If you fixed only 1 minor issue, the gap can be 3-8 points.",
  "  - NEVER set revisedScore equal to or lower than originalScore unless the text was already perfect.",
  "",
